...
public class BlockStatueRoku extends Block {

	@SideOnly(Side.CLIENT)
	private IIcon avatarRokuStatue;
	
	public BlockStatueRoku() {
		super(Material.rock);
		this.setBlockTextureName("AvatarRokuStatue");
		this.setBlockName("AvatarRokuStatue");
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityRokuStatue();
	}
	
	@Override
	public void registerBlockIcons(IIconRegister iconregister) {
		this.avatarRokuStatue = iconregister.registerIcon(mod_Avatar.modid + ":" + "AvatarRokuStatue");
	}

	@SideOnly(Side.CLIENT)
	public IIcon getIcon(int side, int metadata){
		return this.avatarRokuStatue;
	}
