...
public class TileEntityYangchenRenderer extends TileEntitySpecialRenderer {

	private ModelStatueYangchen model;

	public TileEntityYangchenRenderer() {
		model = new ModelStatueYangchen();
	}
	...
	public void renderModelAt(TileEntity tile, double var2, double var4, double var6, float var8) {
		...
		this.bindTexture(new ResourceLocation(FileLocation.STATUETEXTURE + "AvatarYangchenStatue.png"));
