...
/*
 * Very useful, amazing Bukkit code that we couldn't live without
 */
...
public class Location implements Cloneable {
	...
	public Location(Entity entity) {
		this(entity.worldObj, entity.posX, entity.posY, entity.posZ, entity.rotationYaw, entity.rotationPitch);
	}
	
	public Location(EntityLivingBase entity, boolean eye){
		this(entity.worldObj, entity.posX, entity.posY, entity.posZ, entity.rotationYaw, entity.rotationPitch);
		if(eye){
			this.y += 1.62;
		}
	...
	public Chunk getChunk() {
		return world.getChunkFromBlockCoords(this.getBlockX(), this.getBlockZ());
	}
	 ...
	 */
	public BlockBukkit getBlock() {
		return new BlockBukkit(this.world, this.getBlockX(), this.getBlockY(), this.getBlockZ());
	}
	...
	//Added by kieranvs
	/** Gets a Vector pointing to another Location
	 * 
	 * @param loc
	 * 			The other location
	 * @return Vector
	 */
	public Vector getDirectionTo(Location loc){
		return loc.clone().subtract(this).toVector();
	}
	...
	public double distance(Entity e) {
		return this.distance(new Location(e.worldObj, e.posX, e.posY, e.posZ));
	}
