...
public class EntityAvatarFlameFX extends EntityFX {

	/** the scale of the flame FX */
	private float flameScale;

	public EntityAvatarFlameFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
