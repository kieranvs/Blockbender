...
public class EntityEarthBandit extends EntityMob {
	
	private boolean isBending;
	public ResourceLocation res;

	public EntityEarthBandit(World par1World) {
		super(par1World);
		this.tasks.addTask(0, new EntityAISwimming(this));
		this.tasks.addTask(1, new EntityAIAttackWithBending(this, "EARTH"));	
		...
		this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityWaterBandit.class, 0, false));
		
		res = new ResourceLocation(FileLocation.ENTITYTEXTURE + "EarthBandit.png");
	}
