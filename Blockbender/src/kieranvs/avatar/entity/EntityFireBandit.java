...
public class EntityFireBandit extends EntityMob {
	
	private boolean isBending;
	public ResourceLocation res;

	public EntityFireBandit(World par1World) {
		super(par1World);
		this.tasks.addTask(0, new EntityAISwimming(this));
		this.tasks.addTask(1, new EntityAIAttackWithBending(this, "FIRE"));	
		...
		res = new ResourceLocation(FileLocation.ENTITYTEXTURE + "FireBandit.png");
	}
