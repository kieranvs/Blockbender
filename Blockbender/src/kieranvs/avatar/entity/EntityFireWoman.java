...
public class EntityFireWoman extends EntityPerson {

	public EntityFireWoman(World par1World) {
		super(par1World);
	}
	
	public EntityFireWoman(World par1World, int xOrigin, int yOrigin, int zOrigin, int radiusOfTown) {
	...
	public String getTextureLocation() {
		return FileLocation.ENTITYTEXTURE + "FireNationWoman.png";
	}
